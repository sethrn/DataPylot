...
class SaveRenameFrame(GenerateCodeFrame):
    def __init__(self, parent, manager):
        super().__init__(parent)

        self.manager = manager
        self.params = manager.params
        self.current_df = self.params['df_name']
    ...
    def generate_code(self):
        ...
        code, imports = RenameExecutor.generate(
            df=self.params['df_name'],
            feature=self.params['feature'],
            values=self.params['values'],
            rename=self.params['rename'],
